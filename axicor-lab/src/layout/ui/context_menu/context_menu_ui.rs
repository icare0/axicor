...
/// Унифицированная система отрисовки контекстного меню (WM Side)
pub fn context_menu_ui_system(
    ...
    // 1. Поглощение намерений на открытие
    for ev in open_events.read() {
        ...
        // 2. Инъекция глобальных действий WM (Инвариант)
    ...
    // 3. Рендер поверх всех слоев (Order::Foreground)
                ...
                ui.with_layout(egui::Layout::top_down(egui::Align::Min), |ui| {
                    ...
                    for action in &state.actions {
                        ...
                        if ui.add(btn).clicked() {
                            // 4. Делегирование намерения (Intent Routing)
