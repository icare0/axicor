                ...
                ctx_menu_events.send(layout_api::OpenContextMenuEvent {
                    ...
                    actions: vec![
                        layout_api::MenuAction {
                            action_id: format!("node_editor.connect_matrix|{}|{}|{}|{}|{}", src_zone, src_port, target_zone, "in", voxel_z),
                            label: format!("🔗 Connect to Z-Voxel {}", voxel_z),
                        },
                        layout_api::MenuAction {
                            action_id: format!("node_editor.connect_global|{}|{}|{}", src_zone, src_port, target_zone),
