...
pub fn draw_dendrite_filter_section(ui: &mut egui::Ui, nt: &mut NeuronType, all_type_names: &[String]) -> bool {
    let mut changed = false;
    egui::CollapsingHeader::new(egui::RichText::new("Dendrite Whitelist").strong().color(egui::Color32::from_rgb(200, 200, 220)))
        .default_open(true)
        .show(ui, |ui| {
