...
pub fn draw_type_selector(
    ...
    ui.horizontal(|ui| {
        ...
        // [DOD FIX]   ( 16,  1)
        if ui
            .add_enabled(types.len() < 16, egui::Button::new("+"))
            .on_hover_text("Add new type (Max 16)")
            .clicked()
        {
            action = TypeAction::Add;
        }
        if ui
            .add_enabled(types.len() > 1, egui::Button::new(""))
            .on_hover_text("Delete selected type")
            .clicked()
        {
