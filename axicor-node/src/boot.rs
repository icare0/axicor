...
let node_runtime = NodeRuntime::boot(
    ...
    fn parse_manifests_from_vfs(archive: &axicor_core::vfs::AxicArchive, zone_name: &str) -> Result<(ZoneManifest, axicor_core::config::SimulationConfig)> {
        ...
        let sim_config: axicor_core::config::SimulationConfig = toml::from_str(std::str::from_utf8(sim_bytes)?)
        ...
        -> Result<(Vec<BootShard>, HashMap<u32, Vec<u32>>, HashMap<u32, *mut axicor_core::layout::BurstHeads8>, Vec<(u32, crate::network::io_server::ZoneIoContext)>, Vec<u32>, HashMap<u32, Vec<(String, u32, usize, usize)>>)> 
    {
        ...
        for (zone_manifest, zone_name) in zone_manifests_with_names {
            ...
            let instance_config = axicor_core::config::InstanceConfig::parse(std::str::from_utf8(shard_toml_bytes)?)
    ...
    fn build_routing_channels_vfs(
        ...
        Vec<(*mut axicor_core::layout::BurstHeads8, *mut axicor_core::layout::BurstHeads8, IntraGpuChannel)>, 
        Vec<(*mut axicor_core::layout::BurstHeads8, crate::network::inter_node::InterNodeChannel)>, 
