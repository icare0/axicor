...
class PwmEncoder:
    ...
    def _manual_packbits(self):
        # ⚡ Bolt Optimization: Replacing np.multiply/np.sum with a single np.dot operation
        # reduces Gen0 GC overhead by bypassing the intermediate _mul_temp buffer,
        # speeding up packbits performance significantly.
