...
adaptive_leak_max = 500          # Максимальное увеличение утечки при высоком пороге
adaptive_leak_gain = 10          # Множитель прироста утечки от гомеостаза
adaptive_mode = 1                # 1 = включено, 0 = отключено

# --- Neuromodulation (R-STDP) ---
d1_affinity = 128                # Чувствительность к LTP при дофамине (128 = 1.0x)
d2_affinity = 128                # Защита связей от депрессии при награде (128 = 1.0x)
...
# --- Neuromodulation ---
d1_affinity = 64                 # Интернейроны слабее реагируют на дофамин
d2_affinity = 64
