...
def run_retina_stress_test():
    ...
    print(f"👁️ Initializing RetinaEncoder ({W}x{H}, Batch={B} ticks)...")
    ...
    if end_gen0 - start_gen0 > 10:
        print(f"❌ FAILURE: Hidden allocation detected in Hot Loop! (Delta: {end_gen0 - start_gen0})")
        sys.exit(1)
    else:
        print("✅ ZERO-GARBAGE INVARIANT CONFIRMED")
