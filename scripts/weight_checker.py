...
check_shard("Cerebellum", "Axicor_Models/mouse_agent/baked/Cerebellum/checkpoint.state")
check_shard("Hippocampus", "Axicor_Models/mouse_agent/baked/Hippocampus/checkpoint.state")
check_shard("LGN_Thalamus", "Axicor_Models/mouse_agent/baked/LGN_Thalamus/checkpoint.state")
check_shard("Motor_Cortex", "Axicor_Models/mouse_agent/baked/Motor_Cortex/checkpoint.state")
check_shard("PFC_Cortex", "Axicor_Models/mouse_agent/baked/PFC_Cortex/checkpoint.state")
check_shard("Striatum", "Axicor_Models/mouse_agent/baked/Striatum/checkpoint.state")
check_shard("V1_Cortex", "Axicor_Models/mouse_agent/baked/V1_Cortex/checkpoint.state")
